...
function DeleteMatterButton() {
  const { activeMatter, deleteMatter } = useContext(MattersContext);
      ...
      >
        <Box sx={style}>
          <Typography id="modal-modal-title" variant="h6" component="h2">
            Do you really want to delete matter "{activeMatter.title}"?
          </Typography>
...
export default DeleteMatterButton;
